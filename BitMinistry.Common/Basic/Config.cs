...
namespace BitMinistry 
{
    ...
    public class Config
    {
        ...
        static string _defaultSqlConnectionString;
        public static string DefaultSqlConnectionString {
            get => _defaultSqlConnectionString ?? (_defaultSqlConnectionString = ConnectionStrings[DefaultSqlConnectionName]);
            set { _defaultSqlConnectionString = value; _defaultSqlConnectionName = null; }
        }

        static string _defaultSqlConnectionName;
        /// <summary>
        /// will fetch a key for default connection, in following order 'main' ?? 'defaultconnection' ?? connectionstrings.first()
        /// </summary> 
        ...
        /// ( [optional] connectionName ?? DefaultSqlConnectionName ; [optional] new configuration [prop: value ] ) 
