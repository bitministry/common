    ...
    public class Extractor
    {
        ...
        public static List<string> ExtractDomains(string text)
        {
            ...
            var domains = linkParser.Matches(text).Cast<Match>()
                .Select(x =>  x.Value.Split( new [] {"@", "//" }, StringSplitOptions.None)[1])
                .Distinct().ToList();
