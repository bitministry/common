...
namespace BitMinistry.Interfaces
{
    public interface IBSqlRawCommander
    {
        ...
        int UpdateAtTable(IDictionary<string, object> parameters, string tableName, string updateWhere );
